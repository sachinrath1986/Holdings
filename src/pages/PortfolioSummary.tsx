...
// Ionic Components
import { IonPage, IonContent, IonList, IonItem, IonGrid, IonRow, IonCol, IonText, IonFooter } from '@ionic/react';
// Custom Components
            ...
            <IonContent fullscreen class="summary-screen-content">
                ...
                <div className="p-1 pb-0">
                    <IonText color="medium">
                        <h6 className="--uppercase --small-text heading-h6">top 5 holdings</h6>
                    </IonText>
                </div>
                                    ...
                                    <div className="w-100 p-1">
                                        <IonGrid class="holdings-grid">
                                            <IonRow>
                                                <IonCol class="pl-0">
                                                    <IonText color="medium">
                                                        <h6 className="--small-text heading-h6">Invested:&nbsp;51009.00</h6>
                                                    </IonText>
                                                    <IonText color="light">
                                                ...
                                                <IonCol class="pr-0">
                                                    <IonText color="success">
                                                        <h6 className="--small-text --text-right heading-h6">+15.36%</h6>
                                                    </IonText>
                                                    <IonText color="success">
