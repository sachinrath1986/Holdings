...
import {IonPage, IonRow, IonCol, IonButton, IonLabel, IonInput, IonText, IonAvatar, IonCheckbox, IonGrid } from '@ionic/react';
  ...
  return (
    <IonPage id="login-page">
      ...
      <form className='login-form'>
        ...
        <IonInput value={''}  type='email' placeholder="Enter email" className='input' onIonChange={e => {}}></IonInput>
